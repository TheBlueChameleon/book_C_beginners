...
\tabcrlf
    ...
    long double             & \textcolor{grey}{a damn lot}                                  & \textcolor{grey}{10 Byte} \\
...
\item integer definitions: \url{https://en.cppreference.com/w/c/types/integer} (as defined in header \texttt{stdint.h})
\end{itemize}
