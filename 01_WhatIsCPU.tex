...
\begin{hintbox}[Everything is up for interpretation!]
...
\end{cmdbox}
%
\begin{cmdbox}[Executing a program in Windows]
\$ a
\end{cmdbox}
\end{tcbraster}

\begin{hintbox}[Pure Text Files]
...
\begin{hintbox}[Extensions matter]
...
\end{minted}
\captionof{code}{Show a chameleon}
\end{codebox}
...
\subsection*{Solution: Compiling Code}
\begin{cmdbox}[Compiling and executing the code in chameleon.c]
\begin{minted}{text}
